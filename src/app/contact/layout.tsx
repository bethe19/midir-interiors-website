...
export const metadata: Metadata = {
  ...
  description:
    "Speak with MIDIR Interior Design & Construction about interior design, custom furniture, or renovation projects in Addis Ababa, Ethiopia.",
  openGraph: {
    title: "Contact Interior Designers in Addis Ababa",
    description:
      "Speak with MIDIR Interior Design & Construction about interior design, custom furniture, or renovation projects in Addis Ababa, Ethiopia.",
...
const contactSchema = {
  ...
  url: `${SITE_URL}/contact`,
  description:
    "Contact MIDIR Interior Design & Construction to schedule an interior design consultation in Addis Ababa.",
  mainEntity: {
